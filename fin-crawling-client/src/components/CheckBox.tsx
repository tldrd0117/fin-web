...
export default ({label="", ...props }) => {
    ...
    return <>
        ...
        `}</style>
        <div {...props} onClick={handleClick} className={`cursor-pointer relative flex checkComponent items-center ${props.className?props.className:""}`} >
            ...
            {
                checked?
                <div className={"select-none checkBox flex items-center justify-center absolute pointer-events-none"}>
            ...
            <label className={"select-none cursor-pointer ml-1 label text-gray-400 text-sm"}>{label}</label>
        </div>
    </>
}